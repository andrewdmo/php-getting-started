                ...
                <div class="box">
                    ...
                    <form class="settings">
                        ...
                        <fieldset class="col-group">
                            ...
                            <div class="setting-field col w-8 last">
                                <label class="choice mr yes"><input type="radio" name="external"
                                                                    value="y"> <?= lang('yes') ?></label> <label
                                        class="choice chosen no"><input type="radio" name="external" value="n"
                                                                        checked="checked"> <?= lang('no') ?></label>
                            </div>
                        </fieldset>
