<div class="grid-item" data-field-name="<?= $field_name ?>">
    <div class="grid-fields">
        ...
        <fieldset
                class="col-group<?php if (in_array('grid[cols][' . $field_name . '][col_label]', $error_fields)): ?> invalid<?php endif ?>">
            <div class="setting-txt col w-16">
                <h3><?= lang('label') ?></h3>
        ...
        <fieldset
                class="col-group<?php if (in_array('grid[cols][' . $field_name . '][col_name]', $error_fields)): ?> invalid<?php endif ?>">
            <div class="setting-txt col w-16">
        ...
        <fieldset
                class="col-group<?php if (in_array('grid[cols][' . $field_name . '][col_instructions]', $error_fields)): ?> invalid<?php endif ?>">
            <div class="setting-txt col w-16">
        ...
        <fieldset
                class="col-group last<?php if (in_array('grid[cols][' . $field_name . '][col_width]', $error_fields)): ?> invalid<?php endif ?>">
            <div class="setting-txt col w-16">
