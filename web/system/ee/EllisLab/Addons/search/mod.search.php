    ...
    function search_js_switcher($nested = 'n', $id = 'searchform')
    {
        ...
        <script type="text/javascript">
            ...
            function changemenu(index) {
                ...
                with (theSearchForm.elements['cat_id[]']) {    <?php
                    ...
                    if (channels == "<?php echo $key ?>") {    <?php echo "\n";
                        ...
                        ?>
                        categories[i] = new Option("<?php echo addslashes($v['2']);?>", "<?php echo $v['1'];?>");
                        i++; <?php echo "\n";
                        }
                        }
                        }
