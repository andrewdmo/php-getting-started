...
<fieldset class="shun">
    ...
    <div class="group">
        <label for="keywords"
               class="js_hide"><?= lang('keywords') ?> </label><?= form_input('keywords', $keywords, 'class="field shun" placeholder="' . lang('keywords') . '"') ?>
        <br/>
        ...
        <img src="<?= $cp_theme_url ?>images/indicator.gif" class="searchIndicator" alt="Edit Search Indicator"
             style="margin-bottom: -5px; visibility: hidden;" width="16" height="16"/>
    </div>
</fieldset>
<?= form_close() ?>
