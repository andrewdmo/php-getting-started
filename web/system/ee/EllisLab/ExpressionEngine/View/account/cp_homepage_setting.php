<label class="choice block<?php if ($member->cp_homepage == ''): ?> chosen<?php endif ?>">
    <input type="radio" name="cp_homepage"
           value=""<?php if ($member->cp_homepage == ''): ?> checked<?php endif ?>> <?= lang('member_group_default') ?>
</label>
<label class="choice block<?php if ($member->cp_homepage == 'overview'): ?> chosen<?php endif ?>">
    <input type="radio" name="cp_homepage"
           value="overview"<?php if ($member->cp_homepage == 'overview'): ?> checked<?php endif ?>> <?= lang('cp_overview') ?>
</label>
<label class="choice block<?php if ($member->cp_homepage == 'entries_edit'): ?> chosen<?php endif ?>">
    <input type="radio" name="cp_homepage"
           value="entries_edit"<?php if ($member->cp_homepage == 'entries_edit'): ?> checked<?php endif ?>> <?= lang('edit_listing') ?><?php if (bool_config_item('multiple_sites_enabled')): ?> &mdash;
        <i><?= lang('applies_to_all_sites') ?></i><?php endif ?>
</label>
<label class="choice block<?php if ($member->cp_homepage == 'publish_form'): ?> chosen<?php endif ?>">
    <input type="radio" name="cp_homepage"
           value="publish_form"<?php if ($member->cp_homepage == 'publish_form'): ?> checked<?php endif ?>> <?= lang('publish_form') ?>
...
<label class="choice block<?php if ($member->cp_homepage == 'custom'): ?> chosen<?php endif ?>">
    <input type="radio" name="cp_homepage"
           value="custom"<?php if ($member->cp_homepage == 'custom'): ?> checked<?php endif ?>> <?= lang('custom_uri') ?>
</label>
