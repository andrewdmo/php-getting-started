...
<div class="tbl-ctrls">
    ...
    <section class="item-wrap email">
        <div class="item">
            ...
            <h3><b>Date:</b> <?= $localize->human_time($email->cache_date) ?><br><b>From:</b> <a
                        href="<?= ee('CP/URL')->make('myaccount', array('id' => $email->member_id)) ?>"><?= $email->member_name ?></a><br><b>To:</b> <?= $email->recipient_name ?>
                <br><b>Subject:</b> <?= $email->subject ?></h3>
            <div class="message">
                <?= $email->message ?>
            </div>
        </div>
