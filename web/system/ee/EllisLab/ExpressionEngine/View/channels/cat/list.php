    ...
    <?php if ($can_create_categories): ?>
        <fieldset class="tbl-search right">
            <a class="btn tn action"
               href="<?= ee('CP/URL')->make('channels/cat/create-cat/' . $cat_group->group_id) ?>"><?= lang('create_new') ?></a>
        </fieldset>
    <?php endif; ?>
    <h1><?= $cp_page_title ?></h1>
                ...
                <?php if (count($categories->children()) == 0): ?>
                    <li>
                        <div class="tbl-row no-results">
                            <div class="none">
                                <p><?= lang('categories_not_found') ?> <a class="btn action"
                                                                          href="<?= ee('CP/URL')->make('channels/cat/create-cat/' . $cat_group->group_id) ?>"><?= lang('create_category_btn') ?></a>
                                </p>
                            </div>
                        </div>
                    </li>
