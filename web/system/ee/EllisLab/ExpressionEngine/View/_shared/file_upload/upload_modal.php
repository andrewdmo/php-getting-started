<div id="file_uploader" class="pageContents">
    ...
    <div class="button_bar ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">
        ...
        <img src="<?= PATH_CP_GBL_IMG ?>/indicator_upload.gif" alt="<?= lang('loading') ?>..."
             class="before_upload visualEscapism loading"/>
        <input type="submit" class="before_upload disabled-btn" name="upload_file" value="<?= lang('upload_file') ?>"
               id="upload_file"/>
        <input type="submit" class="file_exists submit" name="rename_file" value="<?= lang('rename_file') ?>"
               id="rename_file"/>
        ...
        <input type="submit" class="after_upload filebrowser submit" name="edit_file_modal"
               value="<?= lang('edit_file') ?>" id="edit_file_modal"/>
        <input type="submit" class="edit_modal filebrowser submit" name="save_file" value="<?= lang('save_file') ?>"
               id="save_file"/>
        <input type="submit" class="after_upload edit_modal filebrowser submit" name="choose_file"
               value="<?= lang('use_file') ?>" id="choose_file"/>
    </div>
</div>
<script>
