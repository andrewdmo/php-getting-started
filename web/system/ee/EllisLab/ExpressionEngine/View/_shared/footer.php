...
<footer>
    <section class="product-bar <?php if (!empty($version_identifier)): ?>pre-release<?php endif ?>">
        <div class="snap">
            <div class="left">
                ...
                ?>
                <p><b>ExpressionEngine</b> <span
                            class="version<?php if (isset($new_version)): ?> out-of-date<?php if ($new_version['security']): ?>-vital<?php endif; endif ?>"
                            title="<?= $ver_title ?>"><?= $formatted_version ?></span></p>
                <div class="version-info">
                    ...
                    <?php if (isset($new_version)): ?>
                        <h3><?= lang('latest_version') ?> (<a
                                    href="<?= ee()->cp->masked_url('https://store.ellislab.com/manage') ?>"
                                    rel="external"><?= lang('download') ?></a>)</h3>
                        <p>
            ...
            <div class="right">
                <p>
                    <?php if (ee()->cp->allowed_group('can_access_footer_report_bug')): ?>
                        <a href="https://expressionengine.com/support/bugs/new"
                           rel="external"><?= lang('report_bug') ?></a>
                    ...
                    <?php if (ee()->cp->allowed_group('can_access_footer_new_ticket')): ?>
                        <a href="https://expressionengine.com/support/ticket/new"
                           rel="external"><?= lang('new_ticket') ?></a>
    ...
    <section class="footer">
        <div class="snap">
            <div class="left">
                <p>&copy;<?= date('Y') ?> <a href="<?= ee()->cp->masked_url('https://ellislab.com/') ?>" rel="external">EllisLab</a>,
                    Inc.<br><a class="scroll" href="#top"><?= lang('scroll_to_top') ?></a></p>
            </div>
            <div class="right">
                <p>
                    ...
                    <?php else: ?>
                        <?php if (ee()->cp->allowed_group('can_access_sys_prefs')): ?>
                            <a class="btn no-reg"
                               href="<?= ee('CP/URL')->make('settings/license') ?>"><?= lang('register_now') ?></a>
                        <?php else: ?>
                            <?= lang('not_entered') ?>
                        <?php endif ?>
                    <?php endif; ?>
    ...
    <div class="modal">
        <div class="col-group snap">
            <div class="col w-16 last">
                ...
                <div class="box">
                    <h1>Log into <?= ee()->config->item('site_name') ?> <span
                                class="req-title"><?= lang('required_fields') ?></span></h1>
                    ...
                    <fieldset class="col-group required">
                        ...
                        <div class="setting-field col w-8 last">
                            ...
                            <input type="hidden" name="username"
                                   value="<?= form_prep(ee()->session->userdata('username')) ?>">
                        </div>
                    </fieldset>
