...
<div class="tab-wrap">
    <ul class="tabs">
        ...
        <li><a<?php if ($active_tab == 1): ?> class="act"<?php endif; ?> href="" rel="t-1"><?= lang('rotate') ?></a>
        </li>
        <li><a<?php if ($active_tab == 2): ?> class="act"<?php endif; ?> href="" rel="t-2"><?= lang('resize') ?></a>
        </li>
    </ul>
    ...
    <div class="tab t-0<?php if ($active_tab == 0): ?> tab-open<?php endif; ?>">
        <fieldset class="col-group <?= form_error_class('crop_width') ?> <?= form_error_class('crop_height') ?>">
            ...
            <div class="setting-field col w-8 last">
                <label class="short-txt"><input type="text" name="crop_width"
                                                value="<?= set_value('crop_width', $width) ?>"> <?= lang('width') ?>
                </label> <?= form_error('crop_width') ?>
                <label class="short-txt"><input type="text" name="crop_height"
                                                value="<?= set_value('crop_height', $height) ?>"> <?= lang('height') ?>
                </label> <?= form_error('crop_height') ?>
            </div>
        </fieldset>
        <fieldset class="col-group <?= form_error_class('crop_x') ?> <?= form_error_class('crop_y') ?>">
            ...
            <div class="setting-field col w-8 last">
                <label class="short-txt"><input type="text" name="crop_x"
                                                value="<?= set_value('crop_x', 0) ?>"> <?= lang('x_axis') ?>
                </label> <?= form_error('crop_x') ?>
                <label class="short-txt"><input type="text" name="crop_y"
                                                value="<?= set_value('crop_y', 0) ?>"> <?= lang('y_axis') ?>
                </label> <?= form_error('crop_y') ?>
            </div>
        </fieldset>
    ...
    <div class="tab t-2<?php if ($active_tab == 2): ?> tab-open<?php endif; ?>">
        <fieldset class="col-group <?= form_error_class('resize_width') ?> <?= form_error_class('resize_height') ?>">
            ...
            <div class="setting-field col w-8 last">
                <label class="short-txt"><input type="text" name="resize_width"
                                                value="<?= set_value('resize_width', $width) ?>"> <?= lang('width') ?>
                </label> <?= form_error('resize_width') ?>
                <label class="short-txt"><input type="text" name="resize_height"
                                                value="<?= set_value('resize_height', $height) ?>"> <?= lang('height') ?>
                </label> <?= form_error('resize_height') ?>
            </div>
        </fieldset>
        <figure class="img-preview">
            <img src="<?= $file->getAbsoluteURL() ?>">
