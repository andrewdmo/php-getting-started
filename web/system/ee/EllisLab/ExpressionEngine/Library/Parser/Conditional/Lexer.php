...
class Lexer extends AbstractLexer
{
    ...
    private function addToken($type, $lexeme)
    {
        ...
        if ($lexeme != '' || $type == 'STRING') {
            ...
            switch ($type) {
                case 'BOOL':
                    $obj = new Boolean($lexeme);
                    break;
                case 'COMMENT':
                    $obj = new Comment($lexeme);
                    break;
                case 'NUMBER':
                    $obj = new Number($lexeme);
                    break;
                case 'OPERATOR':
                    $obj = new Operator($lexeme);
                    break;
                case 'OTHER':
                    $obj = new Other($lexeme);
                    break;
                case 'STRING':
                    $obj = new StringLiteral($lexeme);
                    break;
                case 'TAG':
                    $obj = new Tag($lexeme);
                    break;
                case 'VARIABLE':
                    $obj = new Variable($lexeme);
                    break;
                default:
