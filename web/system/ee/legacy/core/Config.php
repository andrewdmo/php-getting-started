...
class EE_Config
{
    ...
    function _initialize()
    {
        ...
        // @todo - rewrite the feature of 'global_vars' to be out of the oldindex.php
     ...
     *    the oldindex.php file.  This loop permits this to happen.
     *
     * @access    private
     * @return    void
     */
     ...
     * to be assigned or overriden by variables contained in the oldindex.php file
     *
     * @access    private
     * @param    array
     * @return    void
