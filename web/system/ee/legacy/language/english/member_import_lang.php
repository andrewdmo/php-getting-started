...
$lang = array(
    ...
    'default_settings_blurb' => 'Set any options you wish to use as defaults.  Please note that these default settings will only be used when a value is
not implicitly given in the XML file.  These options will NOT override XML data.',
    ...
    'info_blurb' => 'In order to use this utility, you must first put the file containing your exported member data
on your server, and then submit the location of the file.',
    ...
    'password_field_warning' => 'Note: If you do not match one of your fields to "Password", random encrypted passwords will
be assigned and imported users will need to use the "Forgot Password" link to log in.',

    'password_warning' => 'Password Warning',

    'password_warning_blurb' => 'If a password was not supplied, your imported members will need to use the "Forgot Password" link
to log in.  Also, if your ExpressionEngine encryption settings (sha1/md5) do not match the encryption
type of your imported data, the passwords will not work, and affected members will need to use the
"Forgot Password" link as well.  Passwords of type="text" will be encrypted for you during the import.',
