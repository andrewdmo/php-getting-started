            ...
            <tr>
                ...
                foreach ($this->buttons as $val) {
                    ...
                    <div class='htmlButtonInner'>
                        <div class='htmlButtonOff' id='button_<?php echo $i; ?>'><a href='javascript:nullo();'
                                                                                    title="<?php echo $val['3']; ?>"
                                                                                    name='button_<?php echo $i; ?>'
                                                                                    onclick='taginsert(this, "<?php echo htmlspecialchars($val['1']); ?>", "<?php echo htmlspecialchars($val['2']); ?>")'><?php echo htmlspecialchars($val['0']); ?></a>
                        </div>
                    </div></td><?php echo "\n";
                ...
                <td class='htmlButtonOuter'>
                    <div class='htmlButtonInner'>
                        <div class='htmlButtonOff'><a href='javascript:promptTag("email");'>&nbsp;@&nbsp;</a></div>
                    </div>
                </td>
                <td class='htmlButtonOuter'>
                    <div class='htmlButtonInner'>
                        <div class='htmlButtonOff'><a href='javascript:promptTag("link");'>&lt;a&gt;</a></div>
                    </div>
                </td>
                ...
                if (ee()->config->item('remove_close_all_button') !== 'y') {
                    ...
                    <td class='htmlButtonOuter'>
                        <div class='htmlButtonInner'>
                            <div class='htmlButtonOff'><a href='javascript:closeall();'>{lang:close_tags}</a></div>
                        </div>
                    </td>
