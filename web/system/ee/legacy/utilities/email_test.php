...
<form method="post" action="<?php echo $action; ?>">
    ...
    <p>Email Address<br/><input type="text" name="recipient" value="<?php echo htmlentities($recipient); ?>" size="32"/>
    </p>
    <p>Email Subject<br/><input type="text" name="subject" value="<?php echo htmlentities($subject); ?>" size="32"/></p>
    <p>Email Message<br/><textarea name="message" cols="30" rows="10"><?php echo htmlentities($message); ?></textarea>
    </p>
