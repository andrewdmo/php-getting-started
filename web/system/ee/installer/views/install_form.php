...
<fieldset class="col-group  <?= form_error_class('install_default_theme') ?> last">
    ...
    <div class="setting-field col w-8 last">
        <label class="choice mr yes"><input name="install_default_theme" value="y"
                                            type="radio" <?= set_radio('install_default_theme', 'y'); ?>> <?= lang('yes') ?>
        </label>
        <label class="choice chosen no"><input name="install_default_theme" value="n"
                                               type="radio" <?= set_radio('install_default_theme', 'n', TRUE); ?>> <?= lang('no') ?>
        </label>
...
<fieldset class="form-ctrls <?= form_error_class('license_agreement') ?>">
    <div class="password-req required">
        ...
        <div class="setting-field col w-8 last">
            <label class="choice"><input type="checkbox" name="license_agreement"
                                         value="y" <?= set_checkbox('license_agreement', 'y') ?>> yes</label>
