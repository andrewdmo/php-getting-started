<div class="shade">
    ...
    <form action="<?= $action_url ?>" method="post" accept-charset="utf-8">
        ...
        <div>
            ...
            <?= form_radio('participate_in_survey', 'n', FALSE, 'id="participate_in_survey_n" onclick="document.getElementById(\'survey_body\').style.display=\'none\'"') ?>
            <label for="participate_in_survey_n"><?= lang('no') ?></label>
        </div>
        ...
        <div id="survey_body">
            ...
            <div class="pad">
                ...
                <?= form_radio('send_anonymous_server_data', 'n', FALSE, 'id="send_anonymous_server_data_n"') ?> <label
                        for="send_anonymous_server_data_n"><?= lang('no') ?></label>
                <span style="font-size:smaller"><?= lang('what_server_data_is_sent') ?>
                    <a href="#"
                       onclick="toggle_server_data();return false;"><?= lang('show_hide_to_see_server_data') ?></a>
			</span>
