...
class Updater
{
    ...
    /**
     * Clean up the quick tab links so they no longer have oldindex.php and session
     * ID in them
     *
     * NOTE: This is duplicated from the 2.7.0 updater because it originally
     * only checked for oldindex.php, but the user could be using admin.php or
    ...
    /**
     * Remove the oldindex.php and Session ID from quick tabs
